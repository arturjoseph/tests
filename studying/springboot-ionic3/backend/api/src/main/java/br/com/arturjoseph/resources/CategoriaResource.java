...
import br.com.arturjoseph.dtos.CategoriaDTO;
import br.com.arturjoseph.services.CategoriaService;
...
public class CategoriaResource {
	...
	public ResponseEntity<Page<CategoriaDTO>> findAllPagenable(
			@RequestParam(value = "page", defaultValue = "0") Integer page,
			@RequestParam(value = "linesPerPage", defaultValue = "24") Integer linesPerPage,
			@RequestParam(value = "orderBy", defaultValue = "nome") String orderBy,
			@RequestParam(value = "direction", defaultValue = "ASC") String direction) {
		Page<Categoria> listCategoria = service.findAllPagenable(page,linesPerPage, orderBy, direction);
